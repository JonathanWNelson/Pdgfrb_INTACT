---
title: "NUC240212JN 951 Ambient RNA and Doublet Removal"
...
tod = Seurat::Read10X_h5(here("Dataset", "951_raw_feature_bc_matrix.h5")) #Change
toc = Seurat::Read10X_h5(here("Dataset", "951_filtered_feature_bc_matrix.h5")) #Change 
sc = SoupChannel(tod,toc)

 
#Make the Seurat object from the filtered control data
SO <- Read10X_h5(here("Dataset", "951_filtered_feature_bc_matrix.h5"))#Change
...
seurat.obj.f_singlets <- AddMetaData(object = seurat.obj.f_singlets, metadata = "951", col.name = "Sample") #Change
...
saveRDS(seurat.obj.f_singlets, here("Outputs", "951_temp.rds")) #Change
...
saveRDS(SO, here("Outputs", paste0("951_", date, ".rds")))
